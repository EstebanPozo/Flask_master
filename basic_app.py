...
def create_app():
    ...
    if not User.query.filter(User.email == 'esteban@example.com').first():
        user = User(
  ...
  # Create 'member@example.com' user with no roles
    if not User.query.filter(User.email == 'sameera@example.com').first():
        user = User(
    ...
    if not User.query.filter(User.email == 'teddy@example.com').first():
        user = User(
